...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
extern "C" {
static void __nohandler_b(bool b){}
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void registration(bool result) __attribute__ ((weak, alias("__nohandler_b")));
 void scanning(bool begin) __attribute__ ((weak, alias("__nohandler_b")));
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Message::Message()
{
	payload = NULL;
