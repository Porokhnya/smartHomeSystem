...
/*
	...
	---------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		структура такой нагрузки включает в себя ТОЛЬКО данные события, в то время как приходящее сообщение типа "Событие" - содержит расшифровку события в своей нагрузке.
