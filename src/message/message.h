...
/*
	...
	---------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		отсылается модулем при необходимости получения списка модулей, которые онлайн. Структура:
			...
			нагрузка:
				- ID модуля
				- Тип события - "запрос модулей онлайн" (2 байта)
	...
	---------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		отсылается модулем в том случае, когда данные публикуемого в системе слота - изменились на модуле. Структура:
			...
			нагрузка:
				- ID модуля
				- Тип события - "Изменились данные исходящего слота" (2 байта)
