...
*/		
		{
				if( registered() && toMe(m) )
				{
					//TODO: тут проверяем, есть ли у нас события, и отвечаем сообщением EventResponse !!!
				}
		}
		break;
...
{
	DBG(F("Create SlotDataChanged event for slot #"));
	DBGLN(data->getID());
	
	//TODO: тут помещаем событие в список на отсыл !!!
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
