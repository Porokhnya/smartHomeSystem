...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// транспорт
RS485 rs485(RS485_SERIAL, 4, 2); // работаем по RS-485 через Serial, пин переключения приема-передачи - 4, 2 миллисекунды на таймаут чтения входящего байта данных
